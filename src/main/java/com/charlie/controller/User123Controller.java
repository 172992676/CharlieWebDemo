...
public class User123Controller extends GenericController {
    private static final Logger logger = LoggerFactory.getLogger(User123Controller.class);
    ...
    public ModelAndView getUsers1(@RequestParam Integer userId) {
        ...
        //调用service方法得到用户列表
        List<User123> users = userService.getUsers(userId);
